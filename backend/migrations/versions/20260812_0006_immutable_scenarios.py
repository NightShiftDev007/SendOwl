"""Create normalized immutable scenarios with database-enforced sealing.
...
def _create_tables() -> None:
    op.create_table(
        ...
        sa.Column("snapshot_company_name", sa.String(length=300), nullable=False),
    ...
    op.execute(
        ...
        BEGIN
            ...
            IF selected_snapshot.world_model_id IS DISTINCT FROM NEW.world_model_id
               ...
               OR selected_snapshot.company_canonical_name
                  IS DISTINCT FROM NEW.snapshot_company_name
