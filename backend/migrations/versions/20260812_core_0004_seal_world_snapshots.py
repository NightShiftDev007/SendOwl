"""Seal core world snapshots only after their immutable evidence is captured.

Revision ID: 20260812_core_0004
Revises: 20260812_core_0003
...
revision: str = "20260812_core_0004"
down_revision: str | None = "20260812_core_0003"
...
CHILD_TABLES: tuple[str, ...] = ("world_snapshot_evidence",)
...
def downgrade() -> None:
    ...
    # The child trigger and its function survived upgrade from 0003. Drop them
    # before recreating the exact two-table 0003 protection set.
    for table_name in reversed(CHILD_TABLES):
