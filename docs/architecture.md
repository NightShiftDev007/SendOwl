...
`20260818_core_0052` 至 `0059` 分别增加 Project/Graph/SimulationContext、SimulationPlan/图记忆、ReportAgent v2、Project AgendaContext、Evaluation Task Bundle、Chat/Web/App Target、SandOwl 原生媒体采集，以及 Rootless Harbor Evaluation Job。当前 schema head 为 `20260818_core_0059`。
